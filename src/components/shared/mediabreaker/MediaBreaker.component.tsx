...
export const MediaBreaker: React.FC<MediaBreakerProps> = ({ media, title, description }) => {
  return (
    <section className="container max-w-[1800px] bg-primary mx-auto mt-8">
      <div className="flex flex-col pb-8 md:pb-0 md:flex-row items-center gap-6 text-primary-foreground aspect-[1500/654]">
        {/* Text Content */}
        <div className="flex-1 text-left mb-8 sm:mb-0 ml-0 md:ml-10 lg:ml-20 order-2 md:order-1">
          <h2 className="text-3xl sm:text-4xl xl:text-6xl font-medium mb-4 leading-[1] xl:leading-[1.5]">
            {title}
          </h2>
        ...
        <div className="relative w-full h-full md:w-1/2 order-1 md:order-2">
          <Image
            src={media.src}
            alt={title}
            layout="fill"
